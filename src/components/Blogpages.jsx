...
const BlogPages = () => {
    ...
    return (
        <div>
            ...
            <div className="py-16 px-4 mt-10 mb-12 h-96" data-aos="fade-up">
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row  items-center">
                    <div className="lg:w-1/2">
                        ...
                        <p className="text-lg lg:text-xl mb-6">
                            Di sini, kami berbagi cerita, wawasan, dan pembaruan terbaru tentang upaya kami dalam mengatasi kelaparan global dan mengurangi pemborosan pangan</p>
                    </div>
            ...
            <div className="max-w-6xl mx-auto px-4 bg-gradient-to-t from-[#0096c7] to-[#023e8a]  shadow-2xl shadow-white rounded-full pb-10">
                <div className="flex justify-center  text-white items-center mb-8" data-aos="fade-right">
                    <h1 className="text-4xl flex  sm:mt-32 md:mt-20 font-bold">Popular</h1>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    {dummyData.latest.map((product) => (
                        <button href={product.url} key={product.id} className="no-underline">
                        <div key={product.id} className="bg-white p-4 shadow-md rounded-[40px]" data-aos="fade-up" data-aos-delay="200">
